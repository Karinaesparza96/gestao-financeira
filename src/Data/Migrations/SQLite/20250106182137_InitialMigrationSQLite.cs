    ...
    public partial class InitialMigrationSQLite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitesOrcamentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitesOrcamentos_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LimitesOrcamentos_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LimitesOrcamentos_CategoriaId",
                table: "LimitesOrcamentos",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitesOrcamentos_UsuarioId",
                table: "LimitesOrcamentos",
                column: "UsuarioId");
